...
/**
 * Class ComplementaryColorsTheory
 * 
 * A class for evaluating the color combination based on Complementary Colors theory.
 */
class ComplementaryColorsTheory extends ColorTheory
{
  /**
   * Evaluate the quality of the color combination based on Complementary Colors theory.
   * 
